<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Nacionalidades.aspx.cs" Inherits="Inscripcion.Nacionalidades" %>

 
<asp:Content runat="server" ContentPlaceHolderID="Contenido">
    <h3>Mantenimiento Nacionalidades </h3>
    Id<br />
    <asp:TextBox runat="server" CssClass="form-control" ID="txtId" Width="50"> </asp:TextBox>
    Descripción<br />
    <asp:TextBox runat="server" CssClass="form-control" ID="txtDescripcion" Width="250"></asp:TextBox>
   ...
   <div style="width:100%;float:left">
        <asp:GridView runat="server" Width="100%" DataKeyNames="Id"  OnPageIndexChanging="gvNacionalidades_PageIndexChanging" OnRowCommand="gvNacionalidades_RowCommand" ID="gvNacionalidades" CellPadding="4" ForeColor="#333333" GridLines="None" PageSize="5" AllowPaging="True" AutoGenerateColumns="False">
